...
import { addPhotoToCollection } from "../service/service"


export function ItemCollection({ collection, modal, photoId }) {
    const handleRemove = () => {
        console.log('Remove img id: ')
    }

    const handleAddPhotoToCollection = () => {
        const response = addPhotoToCollection(collection.id, photoId)
    ...
    return (
        <>
            ...
            <div className="right-item">
                {
                    modal
                        ? (<button onClick={handleAddPhotoToCollection}>
                        ...
                        : (<button onClick={handleRemove}><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
